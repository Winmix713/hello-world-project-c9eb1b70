...
const MessageBubble: React.FC<MessageBubbleProps> = ({ message, theme = 'light' }) => {
      ...
      <div
        className={`max-w-md px-4 py-3 rounded-lg shadow-sm ${
          isUser
            ...
            : 'bg-slate-200 text-slate-900 rounded-bl-none border border-slate-300'
        }`}
      >
